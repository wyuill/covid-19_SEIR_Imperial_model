...
#C:\\Users\\Will.Yuill\\Documents\\Git\\covid-19\\

source("modelling/Imperial model/functions.R")

age_specific_parameters <- read_csv("modelling/Imperial model/age_specific_parameters.csv")

populations <- read_csv("modelling/Imperial model/populations.csv", col_types = cols(X1 = col_skip()))
